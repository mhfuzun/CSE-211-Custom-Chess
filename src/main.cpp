...
void displayPieceInfo(const PieceConfig &piece) {
  ...
  std::cout << "Ascii (white): " << piece.display_ascii[0] << std::endl;
  std::cout << "Ascii (black): " << piece.display_ascii[1] << std::endl;
  std::cout << "Display Setting: " << piece.display_on << std::endl;
}
...
int main(int argc, char *argv[]) {
  ...
  std::cout << "\t Background Color: " << config.game_settings.board.backgroundColor << "color" << config.game_settings.board.resetColor << std::endl;
  std::cout << "\t Text Color: " << config.game_settings.board.textColor << "color" << config.game_settings.board.resetColor << std::endl;
